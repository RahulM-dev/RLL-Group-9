...
public class UpdateAndChangePassword {
	...
	public void UpdateAndChangePassword() throws InterruptedException {
		...
		wd.findElement(By.xpath("//*[@id=\"EmailInput\"]")).sendKeys("3133");
		wd.findElement(By.xpath("//*[@id=\"PasswordInput\"]")).sendKeys("student3133");
		...
		wd.findElement(By.xpath("//*[@id=\"floor\"]")).sendKeys("24");
		wd.findElement(By.xpath("//*[@id=\"room\"]")).sendKeys("241");
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		wd.findElement(By.xpath("//*[@id=\"exampleInputEmail1\"]")).sendKeys("student3133");
		Thread.sleep(2000);
		wd.findElement(By.xpath("//*[@id=\"exampleInputPassword1\"]")).sendKeys("3133student");
		Thread.sleep(2000);
		wd.findElement(By.xpath("//*[@id=\"confirmPassword\"]")).sendKeys("3133student");
		Thread.sleep(2000);
