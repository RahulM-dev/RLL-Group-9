...
public class Feedback {
  ...
  public void feedback() throws InterruptedException {
	  ...
	  wd.findElement(By.cssSelector("#EmailInput")).sendKeys("3133");
	  wd.findElement(By.cssSelector("#PasswordInput")).sendKeys("3133");
	  wd.findElement(By.xpath("/html/body/app-root/app-login-user/div/div/div[2]/form/div/div[1]/button")).click();
	  
	  Thread.sleep(2000);
	  
	  wd.findElement(By.xpath("/html/body/app-root/app-userdashboard/div/table/tbody/tr[2]/td[4]/a")).click();
	  //Check the row for which you are submit the feedback
